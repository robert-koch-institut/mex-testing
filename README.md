...
`cosign verify --certificate-identity-regexp "https://github.com/robert-koch-institut/testing" --certificate-oidc-issuer "https://token.actions.githubusercontent.com" ghcr.io/robert-koch-institut/testing:<tag>`
